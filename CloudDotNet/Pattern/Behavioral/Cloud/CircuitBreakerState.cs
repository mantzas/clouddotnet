...
public class CircuitBreakerState
{
    ...
    /// ToString override
    /// </summary>
    /// <returns>A formatted string of the state</returns>
    public override string ToString()
    {
        return
            $"Circuit State: Executions={_currentExecutions} Failures={CurrentFailureCount} LastFailure={LastFailureTimestamp.ToString("o")} RetrySuccesses={RetrySuccessCount}";
    }
